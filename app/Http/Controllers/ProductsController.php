...
class ProductsController extends Controller
{
    ...
    public function zarn()
    {
        $product = collect(self::getProducts())->firstWhere(function ($x) {
            return strtolower($x['name']) === 'zarn';
        });

        return view('products.zarn', compact('product'));
    }

    public function reolyy()
    {
        $product = collect(self::getProducts())->firstWhere(function ($x) {
            return strtolower($x['name']) === 'reolyy';
        });

        return view('products.reolyy', compact('product'));
    }
    ...
    public static function getProducts()
    {
        ...
        return $products_lang[App::getLocale()];
    }
}
